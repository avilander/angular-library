(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('@angular/core'), require('@angular/platform-browser/animations'), require('@angular/material'), require('@angular/cdk/layout'), require('@angular/common'), require('core-js/es7/reflect'), require('zone.js/dist/zone'), require('@angular/cdk/table'), require('@angular/cdk/tree'), require('@angular/forms'), require('@angular/common/http'), require('@angular/material/toolbar')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/platform-browser', '@angular/core', '@angular/platform-browser/animations', '@angular/material', '@angular/cdk/layout', '@angular/common', 'core-js/es7/reflect', 'zone.js/dist/zone', '@angular/cdk/table', '@angular/cdk/tree', '@angular/forms', '@angular/common/http', '@angular/material/toolbar'], factory) :
    (factory((global['angular-library'] = global['angular-library'] || {}),global._angular_platformBrowser,global.ng.core,global._angular_platformBrowser_animations,global._angular_material,global._angular_cdk_layout,global._angular_common,global.coreJs_es7_reflect,global.zone_js_dist_zone,global._angular_cdk_table,global._angular_cdk_tree,global._angular_forms,global._angular_common_http,global._angular_material_toolbar));
}(this, (function (exports,_angular_platformBrowser,_angular_core,_angular_platformBrowser_animations,_angular_material,_angular_cdk_layout,_angular_common,coreJs_es7_reflect,zone_js_dist_zone,_angular_cdk_table,_angular_cdk_tree,_angular_forms,_angular_common_http,_angular_material_toolbar) { 'use strict';
